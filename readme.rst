.. Medical image datasets list documentation master file, created by
   sphinx-quickstart on Mon May  3 22:50:15 2021.
...
**If the content on this page was helpful to you, or if one of our
papers was helpful to you, please cite the following paper:**
...
.. _`Head & Neck`: head-neck.rst
.. _`Chest & Adbdomen`: chest-abdomen.rst
.. _`Pathology & Blood`: pathology-blood.rst
.. _`Others`: others.rst
...
.. _知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议: http://creativecommons.org/licenses/by-nc-sa/4.0/

.. |知识共享许可协议| image:: https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png
   :target: http://creativecommons.org/licenses/by-nc-sa/4.0/
